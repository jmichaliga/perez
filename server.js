...
app.get('/scrape/:artist/:source', async (request, response) => {
  const artist = request.params.artist ? request.params.artist : 'drake'
  const source = request.params.source ? request.params.source : 'e-online'
